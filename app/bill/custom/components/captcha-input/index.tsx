  ...
  (
    ...
    return (
      <div className="mb-3 w-full space-y-3 md:mb-4 lg:flex lg:space-x-3 lg:space-y-0">
        {children && <div className="w-full lg:w-1/2">{children}</div>}
        {!noCaptcha && (
          <Controller
            control={control}
            name="captchaCode"
                      ...
                      <>
                        <div className="flex h-full w-full items-center justify-between pr-2">
                          <div className="relative flex h-full w-full items-center justify-center">
                            <Image
                              src={captcha?.image || DEFAULT_CAPTCHA_IMAGE}
                              fill
                              alt="captcha-image"
                          ...
                          <div
                            className="b-l-dark-100 flex h-full cursor-pointer items-center justify-center"
