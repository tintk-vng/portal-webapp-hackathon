...
const EDUCATION_HOME_PATH = '/hoc-phi/uts?supplierid=909'
const POLICY_URL = 'https://scdn.zalopay.com.vn/zst/zpi/images/bill/file/uts-policy.pdf'
    ...
    <div>
      <div className="relative rounded-2xl bg-white px-[64px] py-[32px] shadow-[0_0px_2px_0_rgba(0,0,0,0.1),_0_1px_5px_0_rgba(0,0,0,0.1)]">
        ...
        <FormProvider {...methods}>
          ...
          {!isBillEmpty && <EmailInput appID={AppID.EDUCATION} themeColor={THEME_COLOR.UTS} />}
        </FormProvider>
        {!isBillEmpty && (
          <Policy
            policyUrl={POLICY_URL}
            policyTitle="Tôi đồng ý với Chính sách thanh toán phí của UTS"
