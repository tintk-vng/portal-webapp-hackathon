...
export default function SupplierSelect({ suppliers }: SupplierSelectProps) {
            ...
            return (
              ...
              >
                <Image
                  ...
                  src={supplier.icon ? cpsImageUrlWithPath(`logo/${supplier.icon}.png`) : ''}
                  width={36}
                  height={36}
                  alt="supplier-logo"
                  loader={({ src }) => src}
  ...
  return (
    <div className="mb-3 md:mb-4">
      <div className="text-base font-bold text-dark-500">Khu vực</div>
