...
interface TopupPackageProps {
  topupPackage: DataPackage
  selectedPackage: DataPackage | undefined
}

export default function TopupPackage({ topupPackage, selectedPackage }: TopupPackageProps) {
  const { amount, status, badgeText } = topupPackage
