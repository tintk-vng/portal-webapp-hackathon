  ...
  return (
    <Layout
      sideContent={
        <>
          <div className="mb-6">
            <Partners appID={AppID.POST_PAID} suppliers={suppliers} />
          </div>

          <PaymentGuide
            title="Cách thanh toán cho thuê bao trả sau"
            descriptions={[
              'Bước 1: Nhập số điện thoại cần thanh toán',
              'Bước 2: Bấm chọn “<b>Tra cứu cước</b>” để tiến hành kiểm tra',
              'Bước 3: Nhập địa chỉ email của bạn, chúng tôi gửi kết quả thanh toán qua email bạn cung cấp',
              'Bước 4: Bấm chọn “<b>Thanh toán ngay</b>” để thanh toán cước và hoàn tất giao dịch',
            ]}
          />
        </>
      }
