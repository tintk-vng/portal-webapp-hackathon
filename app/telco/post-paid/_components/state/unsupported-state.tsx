...
export default function UnsupportedState() {
  return (
    <StateView
      ...
      description="Rất tiếc nhà mạng hiện chưa hỗ trợ dịch vụ điện thoại trả sau qua Zalopay. Xin lỗi vì sự bất tiện, bạn có thể trải nghiệm các dịch vụ viễn thông khác."
    />
  )
}
