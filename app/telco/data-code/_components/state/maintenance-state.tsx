...
const MAINTENANCE_BUTTON_NAME = 'Nạp Data 4G/5G'
...
export default function MaintenanceState({ telcoCode }: MaintenanceStateProps) {
  ...
  const handleClick = () => {
    commonUtil.trackEvent({
      ID: EVENT[AppID.DATA_CODE].CLICK_MAINTENANCE_BUTTON,
  ...
  return (
    <StateView
      ...
      } đang thực hiện bảo trì dịch vụ mua thẻ Data trên Zalopay. Bạn vui lòng quay lại sau ít phút nhé.`}
