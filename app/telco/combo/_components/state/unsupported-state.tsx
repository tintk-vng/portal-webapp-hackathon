...
export default function UnsupportedState({ telcoCode }: UnsupportedStateProps) {
  ...
  return (
    <StateView
      ...
      description={`Rất tiếc nhà mạng ${supplierName} hiện chưa hỗ trợ dịch vụ nạp Combo. Xin lỗi vì sự bất tiện, bạn có thể trải nghiệm các dịch vụ viễn thông khác.`}
    />
  )
}
